new p5(() =>{
    ...
    */
    ...
    // MAIN TILE SHAPE with jagged + height illusion
    noStroke();
    beginShape();
    vertex(-tw, 0 + left + h);
    ...
    // Dune ripple curves — animated sand drift
    if (n >= 0.75) {
        stroke(60, 30, 20, 180);
        strokeWeight(1);
        noFill();

        let t = millis() * 0.0002; // time-based offset
